        ...
        <div class="notification-dropdown" style="position: relative;">
            <button onclick="toggleNotifications()" class="btn-icon" style="background: none; border: none; font-size: 20px; cursor: pointer; position: relative;">
                ...
                <?php if ($unread_count > 0): ?>
                    <span class="badge-count" style="position: absolute; top: -5px; right: -5px; background: red; color: white; border-radius: 50%; padding: 2px 6px; font-size: 10px;"><?= $unread_count ?></span>
                <?php endif; ?>
            </button>
                        ...
                        <?php foreach ($latest_notifs as $n):
                            ...
                            switch ($n['type']) {
                                case 'event_approved':
                                    ...
                                    $message = 'Event Anda telah disetujui oleh admin dan sekarang dapat dilihat oleh pengguna.';
                                    break;
                                case 'event_rejected':
                                    $subject = '❌ Event Ditolak';
                                    $message = 'Mohon maaf, event Anda ditolak oleh admin.';
                                    break;
                                case 'registration':
