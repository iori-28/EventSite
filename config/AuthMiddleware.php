 ...
 * 
 * Middleware untuk authentication & authorization pada protected pages.
 * Ensures user session is always fresh and in sync with database.
 * 
 * Features:
 ...
 * Auth::check('admin'); // Admin only
 * Auth::check(['admin', 'panitia']); // Admin or Panitia
 * 
